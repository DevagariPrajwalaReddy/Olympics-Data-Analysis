...
st.sidebar.image('https://th.bing.com/th?id=OIP.pSpnDdA1pPUKLt1qnLJnvAHaHa&w=250&h=250&c=8&rs=1&qlt=90&o=6&dpr=1.3&pid=3.1&rm=2')
...
if user_menu == 'Country-wise Analysis':
    ...
    top_10df = helper.most_successful_countrywise(df,selected_country)
    st.table(top_10df)
